...
import image3 from '../../../images/wide.png'
...
const ProductDisplayPage = () => {
  ...
  return (
    <section className='container mx-auto p-4 grid lg:grid-cols-2 '>
        <div className=''>
            <div className='bg-white lg:min-h-[65vh] lg:max-h-[65vh] rounded min-h-35 max-h-40 h-full w-full'>
                <img
        ...
        <div className='p-4 lg:pl-7 text-base lg:text-lg'>
            ...
            <h2 className='font-semibold'>Why shop from GrocerEase? </h2>
            <div>
