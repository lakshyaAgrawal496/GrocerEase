...
const Home = () => {
  ...
  return (
   <section className='bg-white'>
      <div className='container mx-auto px-0 rounded-3xl'>
          <div className={`w-full h-full min-h-48 bg-blue-100 rounded-3xl ${!banner && "animate-pulse my-2" } `}>
              <img
                src={banner}
                className='w-full h-full hidden lg:block rounded-3xl'
                alt='banner' 
              />
              <img
                src={banner}
